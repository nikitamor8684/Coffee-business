...
width:100%;
    ...
    .third,.third1,.third2,.itembox{display:block;clear:both;width:100vw;height:400px}
        }
        </style>
</head>
<body>
...
<div style="height:200px;width:680px;background-color:white;" class="itembox"><img src="images/coffee8.webp" height="200px" width="680px"></div>
<div style="background-color:green;height:120px;width:680px;margin-top:40px;padding:10px 200px;color:white;" class="itembox"><h2>A cup of coffee gives you a lot of happiness</h2></div>
</div>
</div>     
      </div>
      ...
      <div style="background-color:white;height:440px;width:1000px;margin:10px;" >
<span  style="float:left;height:400px;width:450px;background-color:whitesmoke">
...
<span  style="float:right;height:400px;width:450px;background-color:white">
...
?>
      ...
      <div style="background-color:whitesmoke;width:1000px;margin:50px 10px;padding:10px 10px;height:400px;clear:both;" >
